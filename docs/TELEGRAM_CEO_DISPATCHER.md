...
| 操作 | 权限 |
|---|---|
| 查看结果 / 日常运营决策 / 读日志 / 跑测试 / 生成文档 | ✅ AI 自主 |
| 内容发布到第三方平台 | ⚠️ AI 自主但需审核 |
| **资金转移 / 真实交易 / 付款 / 钱包操作** | 🔴 **必须 Leo 人工确认** |
| **不可逆删除 / 生产破坏性操作 / 系统权限 / 账号密码** | 🔴 **必须 Leo 人工确认** |
| 对外签约 / 重大法律或商业承诺 | 🔴 **必须 Leo 人工确认** |
